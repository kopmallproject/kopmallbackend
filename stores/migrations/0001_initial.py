# Generated by Django 5.0.7 on 2024-09-03 00:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_updated', models.DateTimeField(auto_now=True, verbose_name='Date Updated')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Date Created')),
                ('status', models.CharField(choices=[('P', 'pending'), ('O', 'ongoing'), ('D', 'delivered'), ('C', 'closed'), ('R', 'refunded')], default='P', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.SmallIntegerField(default=1, verbose_name='Total quantity Available')),
